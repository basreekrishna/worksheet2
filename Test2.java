...
public class TEST2 {
    ...
    public static void main(String[] args) {
        customer obj=new customer(101,"divya",20);
        System.out.println(obj.getid());
        System.out.println(obj.getname());
        System.out.println(obj.getdiscount());
        System.out.println("after seting discount");
        obj.setdiscount(30);
        System.out.println(obj.getdiscount());
        ...
        System.out.println(obj1.getmaountafterdiscount());
